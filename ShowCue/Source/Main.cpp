...
namespace
{
/** Menu bar macOS tối giản — Preferences nằm trong menu ứng dụng "Show Control". */
...
public:
    ...
    const juce::String getApplicationName() override       { return "Show Control"; }
    ...
    public:
                              ...
                              allButtons)
        {
           ...
           #if JUCE_MAC
            // Menu ứng dụng bản địa (cạnh  Apple) — About + Kiểm tra cập nhật + Preferences.
           ...
           #if JUCE_MAC
            // Peer/NSWindow có thể chưa sẵn sàng ngay — defer sau message loop
